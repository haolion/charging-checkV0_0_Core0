...
C_SRCS += \
C:/Program\ Files\ (x86)/Common\ Files/Analog\ Devices/uC-CPU\ v1.1.0/Blackfin/uC-CPU/Ports/cpu_bsp.c 

ASM_SRCS += \
C:/Program\ Files\ (x86)/Common\ Files/Analog\ Devices/uC-CPU\ v1.1.0/Blackfin/uC-CPU/Ports/cpu_a.asm 

OBJS += \
./system/uC-CPU/Ports/Blackfin/CCES/cpu_a.doj \
./system/uC-CPU/Ports/Blackfin/CCES/cpu_bsp.doj 

C_DEPS += \
./system/uC-CPU/Ports/Blackfin/CCES/cpu_bsp.d 

ASM_DEPS += \
./system/uC-CPU/Ports/Blackfin/CCES/cpu_a.d 


# Each subdirectory must supply rules for building sources it contributes
system/uC-CPU/Ports/Blackfin/CCES/cpu_a.doj: C:/Program\ Files\ (x86)/Common\ Files/Analog\ Devices/uC-CPU\ v1.1.0/Blackfin/uC-CPU/Ports/cpu_a.asm
	@echo 'Building file: $<'
