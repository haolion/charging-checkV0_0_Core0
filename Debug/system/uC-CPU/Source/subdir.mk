...
C_SRCS += \
C:/Program\ Files\ (x86)/Common\ Files/Analog\ Devices/uC-CPU\ v1.1.0/common/uC-CPU/Source/cpu_core.c 

OBJS += \
./system/uC-CPU/Source/cpu_core.doj 

C_DEPS += \
./system/uC-CPU/Source/cpu_core.d 


# Each subdirectory must supply rules for building sources it contributes
system/uC-CPU/Source/cpu_core.doj: C:/Program\ Files\ (x86)/Common\ Files/Analog\ Devices/uC-CPU\ v1.1.0/common/uC-CPU/Source/cpu_core.c
	@echo 'Building file: $<'
