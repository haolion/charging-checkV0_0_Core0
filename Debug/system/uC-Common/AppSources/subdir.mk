...
C_SRCS += \
../system/uC-Common/AppSources/adi_app_printf.c 

OBJS += \
./system/uC-Common/AppSources/adi_app_printf.doj 

C_DEPS += \
./system/uC-Common/AppSources/adi_app_printf.d 


# Each subdirectory must supply rules for building sources it contributes
system/uC-Common/AppSources/%.doj: ../system/uC-Common/AppSources/%.c
	@echo 'Building file: $<'
